<template>
  <div class="view-privacy py-5">
    <div class="container pb-5">
      ...
      <p>
        A sua privacidade é importante para nós. É política do Ministério Fiel
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site Ministério Fiel, e outros sites que possuímos e
        operamos.
      </p>
      <p>
      ...
      <p>
        Ao realizar cadastro em nossas páginas, você nos dá permissão para
        utilizar seu e-mail em serviços de plataformas terceiras. Não se
        preocupe, pois seu uso ainda será exclusivo do Ministério Fiel e não
        será utilizado para e-mails ou spams de outras empresas. Não
        compartilhamos informações de identificação pessoal publicamente, exceto
      ...
      <h2 class="pt-4">Política de Cookies Ministério Fiel</h2>
      ...
      <ul>
        <li><h6>Cookies relacionados à conta</h6>
        ...
        <li><h6>Cookies relacionados ao login</h6>
        Utilizamos cookies quando você está logado, para que possamos lembrar dessa ação. Isso evita que você precise fazer login sempre que visitar uma nova página. Esses cookies são normalmente removidos ou limpos quando você efetua logout para garantir que você possa acessar apenas a recursos e áreas restritas ao efetuar login.
        </li>
        <li><h6>Cookies relacionados a boletins por e-mail</h6>Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas para usuários inscritos / não inscritos.</li>
        <li><h6>Pedidos processando cookies relacionados</h6>Este site oferece facilidades de comércio eletrônico ou pagamento e alguns cookies são essenciais para garantir que seu pedido seja lembrado entre as páginas, para que possamos processá-lo adequadamente.</li>
        <li><h6>Cookies relacionados a pesquisas</h6>Periodicamente, oferecemos pesquisas e questionários para fornecer informações interessantes, ferramentas úteis ou para entender nossa base de usuários com mais precisão. Essas pesquisas podem usar cookies para lembrar quem já participou numa pesquisa ou para fornecer resultados precisos após a alteração das páginas.</li>
        <li><h6>Cookies relacionados a formulários</h6>Quando você envia dados por meio de um formulário como os encontrados nas páginas de contacto ou nos formulários de comentários, os cookies podem ser configurados para lembrar os detalhes do usuário para correspondência futura.</li>
        <li><h6>Cookies de preferências do site</h6>Para proporcionar uma ótima experiência neste site, fornecemos a funcionalidade para definir suas preferências de como esse site é executado quando você o usa. Para lembrar suas preferências, precisamos definir cookies para que essas informações possam ser chamadas sempre que você interagir com uma página for afetada por suas preferências.</li>
      </ul>
      ...
      <p>Esta política é efetiva a partir de <strong>August/2020.</strong></p>
    </div>
  </div>
</template>
